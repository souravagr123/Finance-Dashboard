...
const Sidebar = React.forwardRef(
  ({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    return (
      <div ref={ref} className="group peer hidden md:block" data-state={state} {...props}>
        <div className="relative h-svh w-[--sidebar-width]" />
        <div className={cn("fixed inset-y-0 z-10 hidden md:flex", className)}>
...
/* --- Example of pattern for rest (same conversion applied) --- */
...
/* KEEP SAME PATTERN FOR ALL REMAINING COMPONENTS */
